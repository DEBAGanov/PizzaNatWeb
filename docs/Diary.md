...
.category-image { height: 80px; width: 80px; }
.product-card-image { height: 90px; width: 90px; }
...
### 📱 Следующие шаги
1. Протестировать на различных мобильных устройствах
2. Проверить производительность с новыми размерами
3. При необходимости дополнительно оптимизировать
