...
## [1.0.11] - 2025-01-27 - Электронная коммерция Яндекс Метрика

### Добавлено
- 📊 **Электронная коммерция**: Полная интеграция с Яндекс Метрикой согласно официальной документации
- 🛒 **Отслеживание корзины**: Автоматическое отслеживание добавления/удаления товаров
- 💰 **Отслеживание покупок**: Полные данные о заказах включая доставку и товары
- 🔍 **Отслеживание просмотров**: Просмотр товаров и категорий
- 📱 **Enhanced Ecommerce**: Соответствие стандарту Google Analytics Enhanced Ecommerce
- 🧪 **Тестовая страница**: test-ecommerce.html для проверки интеграции

### Реализованные события
- 👁️ **detail**: Просмотр товара (ProductPage)
- ➕ **add**: Добавление в корзину (ProductPage)
- ➖ **remove**: Удаление из корзины (CartPage)
- 🏁 **checkout**: Начало оформления заказа (CheckoutPage)
- 💳 **purchase**: Завершение покупки (CheckoutPage)

### Технические детали
- ✅ **window.dataLayer**: Корректная инициализация контейнера данных
- ✅ **TypeScript типизация**: Полная типизация всех ecommerce интерфейсов
- ✅ **Утилиты**: ecommerceHelpers.ts для преобразования данных проекта
- ✅ **Соответствие стандарту**: 100% соответствие документации Яндекса
