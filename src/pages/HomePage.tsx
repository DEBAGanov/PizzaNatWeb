  ...
  return (
    <SEOPageWrapper 
      ...
      customSeo={{
        ...
        description: 'Доставка пиццы на дом в Волжске за 30-60 минут ⭐ Горячая пицца с доставкой от 800₽ ⭐ Вкуснее чем Додо Пицца на ул. Ленина 52 ⭐ Заказать пиццу с доставкой 24 часа',
