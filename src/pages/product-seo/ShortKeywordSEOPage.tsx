...
export function ShortKeywordSEOPage({ keyword }: ShortKeywordSEOPageProps) {
  ...
  const keywordData = {
    'пицца': {
      ...
      description: "🍕 Пицца в Волжске с доставкой на дом ⭐ 20+ видов итальянской пиццы ⭐ Быстрая доставка за 30-60 минут ⭐ Лучшая пицца в городе ⭐ +7(902)105-34-34",
      keywords: "пицца, пицца волжск, пицца заказать, итальянская пицца, лучшая пицца волжск",
      h1: "Пицца в Волжске",
      subtitle: "Лучшая итальянская пицца с доставкой на дом",
      color: "orange",
