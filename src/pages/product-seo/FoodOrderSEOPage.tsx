        ...
        <Stack gap="xl">
          ...
          <Box>
            ...
            <SimpleGrid cols={{ base: 2, sm: 3, md: 5 }} spacing="md">
              <Card shadow="sm" radius="md" withBorder p="md" style={{ cursor: 'pointer' }} onClick={() => navigate('/menu')}>
                ...
                <Card shadow="sm" radius="md" withBorder>
                  ...
                  <Stack mt="md" gap="xs">
                    ...
                    <Group justify="space-between" align="center">
                      ...
                      <Button size="sm" color="teal" onClick={() => navigate('/menu')}>Заказать</Button>
                    </Group>
                  </Stack>
                </Card>
              </Grid.Col>
                ...
                <Card shadow="sm" radius="md" withBorder p="md" h="100%">
                  <Stack gap="md">
                    ...
                    <Group justify="space-between" align="center">
                      ...
                      <Button color="orange" onClick={() => navigate('/menu')}>Заказать</Button>
                    </Group>
                  </Stack>
                </Card>
              </Grid.Col>
                ...
                <Card shadow="sm" radius="md" withBorder p="md" h="100%">
                  <Stack gap="md">
                    ...
                    <Group justify="space-between" align="center">
                      ...
                      <Button color="yellow" onClick={() => navigate('/menu')}>Заказать</Button>
                    </Group>
                  </Stack>
                </Card>
              </Grid.Col>
                ...
                <Card shadow="sm" radius="md" withBorder p="md" h="100%">
                  <Stack gap="md">
                    ...
                    <Group justify="space-between" align="center">
                      ...
                      <Button color="blue" onClick={() => navigate('/menu')}>Заказать</Button>
                    </Group>
                  </Stack>
                </Card>
              </Grid.Col>
