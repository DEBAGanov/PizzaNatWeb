      ...
      <Stack gap="xl">
        ...
        <Paper p="xl" radius="lg" withBorder bg="gradient-to-r from-orange-50 to-yellow-50">
          <Title order={2} ta="center" c="orange.7" mb="md">
            🥇 Почему ДИМБО Пицца лучше конкурентов в Волжске?
          </Title>
          ...
          <SimpleGrid cols={{ base: 1, md: 2 }} spacing="md">
            ...
            <Paper p="md" radius="md" withBorder>
              ...
              <List spacing="xs" size="sm">
                ...
                <List.Item>✅ <strong>Лучшее тесто</strong> - итальянская рецептура</List.Item>
            ...
            <Paper p="md" radius="md" withBorder>
              ...
              <List spacing="xs" size="sm">
                ...
                <List.Item>✅ <strong>Лучшие сыры</strong> - моцарелла премиум класса</List.Item>
        ...
        <Paper p="md" radius="md" bg="gray.0">
          <Text size="sm" c="dimmed" ta="center">
            <strong>ДИМБО Пицца в Волжске</strong> - ваша лучшая альтернатива всем конкурентам на улице Ленина. 
