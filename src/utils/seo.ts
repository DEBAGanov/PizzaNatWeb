...
export const BASE_SEO = {
  siteName: 'ДИМБО Пицца - Лучшая пиццерия в Волжске',
  defaultTitle: 'ДИМБО Пицца - Лучшая пицца в Волжске | Доставка 30-60 минут',
  defaultDescription: 'ДИМБО Пицца - лучшая альтернатива Додо Пицца в Волжске! Свежие ингредиенты, итальянские рецепты, быстрая доставка. Дешевле конкурентов, вкуснее сетевых пиццерий.',
